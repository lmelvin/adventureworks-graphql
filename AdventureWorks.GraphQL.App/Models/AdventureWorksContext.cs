...
namespace AdventureWorks.GraphQL.App.Models
{
    public partial class AdventureWorksContext : DbContext
    {
        ...
        public virtual DbSet<EmployeeDemo> EmployeeDemo { get; set; }
        ...
        // Unable to generate entity type for table 'HumanResources.NewOrg'. Please see the warning messages.
...
//                optionsBuilder.UseSqlServer("Data Source=.\\sqlexpress;Initial Catalog=AdventureWorks2017;Integrated Security=True");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeDemo>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("EmployeeDemo", "HumanResources");
